...
2. Store in {{contact.readiness_score}} (plain integer only)
3. Store all fields: {{contact.aifyze_business_type}}, {{contact.aifyze_team_size}}, {{contact.aifyze_main_pain_point}}, {{contact.aifyze_current_tools}}, {{contact.aifyze_ai_usage_level}}, {{contact.aifyze_readiness_to_act}}, {{contact.aifyze_score_band}}, {{contact.aifyze_suggested_service}}, {{contact.aifyze_urgency_level}}
4. Send ONE message in chat that contains BOTH the score AND the email ask — do not split into two messages:
...
6. Offer free AI audit: "Want to book a free AI audit to walk through your results with an Aifyze expert?"
